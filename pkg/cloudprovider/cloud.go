...
type TCPLoadBalancer interface {
	...
	CreateTCPLoadBalancer(name, region string, forceLoadBalancer string, ports []*api.ServicePort, hosts []string, affinityType api.ServiceAffinity) (*api.LoadBalancerStatus, error)
